...
export default function CustomCursorAndNav(props) {
    ...
    useEffect(() => {
        window.addEventListener('resize', () => setVSize([window.innerWidth, window.innerHeight]));
    ...
    return (
        <>
            ...
            <div className="title-bar">
                ...
                <nav className="nav">
                    <a href="#" className="link" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
