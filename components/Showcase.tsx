...
import { useGLTF, Loader, Sky, ContactShadows, PresentationControls, Html, PerspectiveCamera } from '@react-three/drei'
    ...
    return (
        <>
            ...
            <Canvas
                ...
                camera={
                    model === 'car' ?  { position: [0, 2, 5], zoom: 1.2 } :
                    model === 'iphone' ? { position: [1, 5, 4], zoom: 0.3 } : {}
                }
                shadows
